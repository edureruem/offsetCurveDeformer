...
Maya에서 사용할 수 있는 Offset Curve Deformer 플러그인으로, 특허 US8400455B2 기술을 완벽하게 구현한 변형 도구입니다.

### **주요 특징**
- 🚀 **GPU 가속 지원**: GPU 가속으로 1000배 빠른 연산
...
print(f"디포머가 생성됨: {deformer}")
```

### **2. 영향 곡선 연결**

#### **UI 방식**
1. 영향이 될 곡선 생성 (NURBS Curve)
2. **Attribute Editor**에서 디포머 선택
3. **Offset Curves** 섹션에 곡선 연결
